      ...
      >
        ...
        <div className="relative z-10 text-center px-4 md:px-12 max-w-3xl">
          ...
          <p className="text-[#E0F2FE] font-medium mb-8 text-base md:text-md">
            Visualize your models’ performance, detect drift, and make data-driven
            decisions. Let ModelTrack AI help you build smarter models — faster
            than ever.
          </p>

          <Link to="/ViewsAllModels"
            className="
